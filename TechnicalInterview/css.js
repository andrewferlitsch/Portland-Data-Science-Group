...
.directive( "questionsCss", function() {
	return {
		...
		template: "<a name='css'/>" +
				  ...
				  "	<span ng-show='answers'><span class='answer'>{{question.answer}}</span> <button class='w3-btn w3-khaki w3-round w3-small' onclick='showBetter(\"css\", \"{{question.id}}\");'>Suggest A Better Answer</button><br/></span>Correct <input class='css-correct' type='checkbox'/><br/><br/></li>" +
				  "</ul>" +
