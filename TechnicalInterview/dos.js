...
.directive( "questionsDos", function() {
	return {
		...
		template: "<a name='dos'/>" +
				  ...
				  "	<span ng-show='answers'><span class='answer'>{{question.answer}}</span> <button class='w3-btn w3-khaki w3-round w3-small' onclick='showBetter(\"dos\", \"{{question.id}}\");'>Suggest A Better Answer</button><br/></span>Correct <input class='dos-correct' type='checkbox'/><br/><br/></li>" +
				  "</ul>" +
