...
.directive( "questionsNetwork", function() {
	return {
		...
		template: "<a name='network'/>" +
				  ...
				  "	<span ng-show='answers'><span class='answer'>{{question.answer}}</span> <button class='w3-btn w3-khaki w3-round w3-small better' name='network'>Suggest A Better Answer</button><br/></span>Correct <input class='network-correct' type='checkbox'/><br/><br/>" +
				  "	</li>" +
				  "</ul>" +
