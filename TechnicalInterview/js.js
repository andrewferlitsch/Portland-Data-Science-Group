...
.directive( "questionsJs", function() {
	return {
		...
		template: "<a name='js'/>" +
				  ...
				  "	<span class='answer'>{{question.answer}}</span> <button class='w3-btn w3-khaki w3-round w3-small better'>Suggest A Better Answer</button><br/>Correct <input class='js-correct' type='checkbox'/><br/><br/>" +
				  "</ul>" +
