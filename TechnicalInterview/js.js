...
.directive( "questionsJs", function() {
	return {
		...
		template: "<a name='js'/>" +
				  ...
				  "	<span ng-show='answers'><span class='answer'>{{question.answer}}</span> <button class='w3-btn w3-khaki w3-round w3-small' onclick='showBetter(\"js\", \"{{question.id}}\");'>Suggest A Better Answer</button><br/></span>Correct <input class='js-correct' type='checkbox'/><br/><br/>" +
				  "</ul>" +
