...
.directive( "questionsSecurity", function() {
	return {
		...
		template: "<a name='security'/>" +
				  ...
				  "	<span ng-show='answers'><span class='answer'>{{question.answer}}</span> <button class='w3-btn w3-khaki w3-round w3-small' onclick='showBetter(\"security\", \"{{question.id}}\");'>Suggest A Better Answer</button><br/></span>Correct <input class='security-correct' type='checkbox'/><br/><br/>" +
				  "</ul>" +
