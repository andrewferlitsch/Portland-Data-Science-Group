...
.directive( "questionsWeb", function() {
	return {
		...
		template: "<a name='web'/>" +
				  ...
				  "	<span class='answer'>{{question.answer}}</span> <button class='w3-btn w3-khaki w3-round w3-small'>Suggest A Better Answer</button><br/>Correct <input class='web-correct' type='checkbox'/><br/><br/></li>" +
				  "</ul>" +
				  "<button class='w3-btn w3-green score' meta='web'>Score</button>" + 
				  "</div>"
	}
});