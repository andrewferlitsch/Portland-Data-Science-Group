...
.directive( "questionsCpp", function() {
	return {
		...
		template: "<a name='cpp'/>" +
				  ...
				  "	<span ng-show='answers'><span class='answer'>{{question.answer}}</span> <button class='w3-btn w3-khaki w3-round w3-small' onclick='showBetter(\"cpp\", \"{{question.id}}\");'>Suggest A Better Answer</button><br/></span>Correct <input class='cpp-correct' type='checkbox'/><br/><br/>" +
				  "</ul>" +
