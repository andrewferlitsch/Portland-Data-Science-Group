...
.directive( "questionsQa", function() {
	return {
		...
		template: "<a name='qa'/>" +
				  ...
				  "	<span ng-show='answers'><span class='answer'>{{question.answer}}</span> <button class='w3-btn w3-khaki w3-round w3-small better' name='qa' id='{{question.id}}'>Suggest A Better Answer</button><br/></span>Correct <input class='qa-correct' type='checkbox'/><br/><br/></li>" +
				  "</ul>" +
