...
.directive( "questionsAngular", function() {
	return {
		...
		template: "<a name='angular'/>" +
				  ...
				  "	<span ng-show='answers'><span class='answer'>{{question.answer}}</span> <button class='w3-btn w3-khaki w3-round w3-small better' name='angular' id='{{question.id}}'>Suggest A Better Answer</button><br/></span>Correct <input class='angular-correct' type='checkbox'/><br/><br/></li>" +
				  "</ul>" +
