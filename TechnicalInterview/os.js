...
.directive( "questionsOs", function() {
	return {
		...
		template: "<a name='os'/>" +
				  ...
				  "	<span class='answer'>{{question.answer}}</span> <button class='w3-btn w3-khaki w3-round w3-small better' name='os'>Suggest A Better Answer</button><br/>Correct <input class='os-correct' type='checkbox'/><br/><br/>" +
				  "</ul>" +
