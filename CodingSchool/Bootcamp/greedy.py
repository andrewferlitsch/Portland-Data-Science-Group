...
class Node:
	...
	_key = None                 # node 
	_visited = UNVISITED        # node has been visited
	
	def __init__(self, key):
		""" constructor """
		self._key = key
		self._neighbors = []	# list of neighboring nodes (vertices)
...
def greedy(root):
	""" Greedy Breadth first search of a graph """
	""" NOT DONE """
